...
export const Navbar = () => {
  ...
  return (
    <header className="fixed top-1 left-0 w-full border-b border-border bg-card/90 backdrop-blur-md z-40">
      <div className="flex justify-between items-stretch h-16 md:h-20 px-4 lg:px-8">
        {/* Logo section */}
        <Link 
          to="/" 

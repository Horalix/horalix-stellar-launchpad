...
export const homepageNewsFallbacks: PublicNewsArticle[] = [
  {
    ...
    content:
      "Horalix continues to share product progress and company milestones with healthcare and innovation audiences.\n\nThe team is focused on building clinical AI workflow software that improves report readiness, structured output, and operational consistency for care teams.",
    category: "NEWS",
    location: "Europe",
    image_urls: [],
    image_focus: [],
  ...
  },
  {
    ...
    content:
      "Demo Day highlighted Horalix product progress across clinical workflow automation and AI-assisted echocardiography reporting.\n\nThe presentation focused on how software can reduce repetitive measurement work while keeping clinicians in control of final review and sign-off.",
    category: "UPDATE",
    location: "Horalix",
    image_urls: [],
    image_focus: [],
  ...
  },
  {
    ...
    content:
      "Horalix was started to address high-friction clinical workflows where manual measurement and reporting work slow teams down after image acquisition.\n\nThe company is building toward faster, more structured reporting systems for hospitals, echo labs, and clinical operators.",
    category: "NEWS",
    location: "Horalix",
    image_urls: [],
    image_focus: [],
